% EKF_SLAM  Simultaneous localization and mapping using an extended Kalman
% filter.
%
%   [mu,Sigma,Ob] = EKF_SLAM(f,g,A,C,Q,R,u,y,mu0,Sigma0,i_angle)
%
...
%   i_closest   (10 x T) time history of the closest features to robot
%
% OUTPUTS:
...
%
%=========================================================================%
function [mu,Sigma,Ob] = EKF_SLAM(f,g,A,C,Q,R,u,y,mu0,Sigma0,i_closest)
    ...
    for t = 2:T
        ...
        z = y(:,t)-g(mu_predict,t,i_closest);
        z(11:20) = wrapToPi(z(11:20));
