%==========================================================================
%
% transform_linear  Linear transformation of mean and covariance.
%
%   [mu_y,Sigma_yy] = transform_linear(mu_x,Sigma_xx,A)
%
% Author: Tamas Kis
...
%
%==========================================================================
function [mu_y,Sigma_yy] = transform_linear(mu_x,Sigma_xx,A)
