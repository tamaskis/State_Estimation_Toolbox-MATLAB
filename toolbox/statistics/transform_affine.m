%==========================================================================
%
% transform_affine  Affine transformation of mean and covariance.
%
%   [mu_y,Sigma_yy] = transform_affine(mu_x,Sigma_xx,A,b)
%
% Author: Tamas Kis
...
%
%==========================================================================
function [mu_y,Sigma_yy] = transform_affine(mu_x,Sigma_xx,A,b)
